...
session_start();
/**ADD FILTERS**/
if( isset($_GET['action']) && $_GET['action']=="ADD" && $_GET['value']!= "-1"){ // borrar filtro respectivo: 
    ...
    if( isset($_GET['idFilter']) && $_GET['idFilter']=="filtPormMatric"){ // agregar filtro promedio matricula POS 2:
    ...
    if( isset($_GET['idFilter']) && $_GET['idFilter']=="filtCostVida"){ // agregar filtro costo de vida POS 3:
...
if( $_GET['value']== "-1" ){ // borrar filtro respectivo:    
    ...
    if( isset( $_GET['idFilter']) && $_GET['idFilter']=="filtPormMatric" ){ //Clear filter Promedio matricula POS 2:
        $_SESSION['arrayFiltersUniv'][2] = "";
        $_SESSION['arrayFiltersSelectedUniv'][2] = "";
    }
    if( isset( $_GET['idFilter']) && $_GET['idFilter']=="filtCostVida" ){ //Clear filter costo de vida POS 3:
